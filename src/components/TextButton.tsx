...
const TextButton: React.FC<{ type?: 'button' | 'submit' | 'reset'; onClick?: React.MouseEventHandler<HTMLButtonElement>; children: React.ReactNode }> = ({ type = 'button', onClick, children }) => {
  return (
    <button
